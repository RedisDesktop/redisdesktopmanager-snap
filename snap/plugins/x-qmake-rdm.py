...
class QmakePlugin(snapcraft.BasePlugin):
    ...
    def schema(cls):
        ...
        schema["properties"]["qmake-binary"] = {
            "type": "string",
            "default": "qmake",
        }
    ...
    def get_build_properties(cls):
        ...
        return ["options", "project-files", "qmake-binary"]
    ...
    def build(self):
        ...
        self.run(
            [self.options.qmake_binary] + self._extra_config() + self.options.options + sources, env=env
        )
